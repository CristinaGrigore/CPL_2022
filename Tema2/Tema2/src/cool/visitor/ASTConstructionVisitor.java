...
public class ASTConstructionVisitor extends CoolParserBaseVisitor<ASTNode> {
 ...
 public ASTNode visitProgram(CoolParser.ProgramContext ctx) {
  ...
  return new Prog(ctx.start, classList);
 }
 @Override
 ...
 public ASTNode visitMethodDef(CoolParser.MethodDefContext ctx) {
  ...
  return new ASTmethodDef(ctx.start, ctx.returnType, ctx.name, params, body);
 }

 @Override
 public ASTNode visitInt(CoolParser.IntContext ctx) {
  return new Int(ctx.start, ctx.INT().getSymbol());
 }
 @Override
 public ASTNode visitId(CoolParser.IdContext ctx) {
  return new Id(ctx.start, ctx.ID().getSymbol());
 }
 @Override
 public ASTNode visitFormal(CoolParser.FormalContext ctx) {

  return new Formal(ctx.start, ctx.type, ctx.name);
 }
 @Override
 public ASTNode visitString(CoolParser.StringContext ctx) {
  return new ASTString(ctx.start, ctx.STRING().getSymbol());
 }
 @Override
 public ASTNode visitBool(CoolParser.BoolContext ctx) {
  return new Bool(ctx.start, ctx.BOOL().getSymbol());
 }
 ...
 public ASTNode visitPlusMinus(CoolParser.PlusMinusContext ctx) {
  ...
  if(ctx.op.getText().equals("+")== true)
   return new Plus(ctx.start, left, right);
  else return new Minus(ctx.start, left, right);
 }
 ...
 public ASTNode visitMultDiv(CoolParser.MultDivContext ctx) {
  ...
  if(ctx.op.getText().equals("*")== true) {
   ...
   return new Mult(ctx.start, left, right);
  }
  else return new Div(ctx.start, left, right);
 }
 public ASTNode visitParen(CoolParser.ParenContext ctx) {
  var expr = ctx.e == null ? null : (Expression)visit(ctx.e);
  return new Paren(ctx.start, expr);
 }
 @Override
 public ASTNode visitNeg(CoolParser.NegContext ctx) {
  var expr = ctx.e == null ? null : (Expression)visit(ctx.e);
  return new Negation(ctx.start, ctx.op, expr);
 }
 @Override
 public ASTNode visitNot(CoolParser.NotContext ctx) {
  var expr = ctx.e == null ? null : (Expression)visit(ctx.e);
  return new Not(ctx.start, ctx.op, expr);
 }
 @Override
 public ASTNode visitRelational(CoolParser.RelationalContext ctx) {
  ...
  var left = ctx.left == null ? null : (Expression)visit(ctx.left);
  var right = ctx.right == null ? null : (Expression)visit(ctx.right);
  return new ASTRelational(ctx.start, ctx.op, left, right);
 }
 @Override
 public ASTNode visitAssign(CoolParser.AssignContext ctx) {
  var name = ctx.name == null ? null : (Expression)visit(ctx.name);
  var e = ctx.e == null ? null : (Expression)visit(ctx.e);
  return new Assign(ctx.start, name, e);
 }
 @Override
 public ASTNode visitAssign2(CoolParser.Assign2Context ctx) {
  var name = ctx.name == null ? null : (Expression)visit(ctx.name);
  var e = ctx.e == null ? null : (Expression)visit(ctx.e);
  return new Assign2(ctx.start, name, e);
 }
 @Override
 public ASTNode visitIsvoid(CoolParser.IsvoidContext ctx) {
  var expr = ctx.e == null? null : (Expression)visit(ctx.e);
  return new IsVoid(ctx.start, expr);
 }
 @Override
 public ASTNode visitNew(CoolParser.NewContext ctx) {
  return new New(ctx.start, ctx.TYPE().getSymbol());
 }
 @Override
 public ASTNode visitImplicitDispatch(CoolParser.ImplicitDispatchContext ctx) {
  var args = ctx.args
          ...
          .collect(Collectors.toList());
  return new ImplicitDispatch(ctx.start, ctx.name, args);
 }
 @Override
 public ASTNode visitFuncCall(CoolParser.FuncCallContext ctx) {
  var args = ctx.args
          ...
          .map(node -> (Expression)visit(node))
          .collect(Collectors.toList());
  return new FuncCall(ctx.start, ctx.name, args);
 }
 @Override
 public ASTNode visitIf(CoolParser.IfContext ctx) {
  ...
  return new If(ctx.start, cond, thenBranch, elseBranch);
 }
 @Override
 public ASTNode visitWhile(CoolParser.WhileContext ctx) {
  var cond = ctx.cond == null ? null : (Expression)visit(ctx.cond);
  var body = ctx.body == null ? null : (Expression)visit(ctx.body);
  return new While(ctx.start, cond, body);
 ...
 public ASTNode visitLet(CoolParser.LetContext ctx) {
  var members = ctx.members
          ...
          .collect(Collectors.toList());
  var body = ctx.body == null ? null : (Expression)visit(ctx.body);
  return new Let(ctx.start, members,body);
 }
 @Override
 public ASTNode visitCase(CoolParser.CaseContext ctx) {
  ...
  var options = ctx.options
          ...
          .collect(Collectors.toList());
  return new Case(ctx.start, name, options);
 }
 @Override
 public ASTNode visitCaseOptions(CoolParser.CaseOptionsContext ctx) {
  ...
  return new CaseOption(ctx.start, ctx.name, ctx.type, value);
 }
 @Override
 ...
 public ASTNode visitDispatch(CoolParser.DispatchContext ctx) {
  ...
  return new Dispatch(ctx.start, value, call);
 }
 @Override
 public ASTNode visitOther_dispatch(CoolParser.Other_dispatchContext ctx) {
  ...
  return new OtherDispatch(ctx.start, value, type, call);
 }
}
